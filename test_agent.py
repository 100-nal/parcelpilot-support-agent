...
# Test 1: Northstar (Enterprise, has custom no-fee cancellation contract)
# should correctly say NO FEE, not the generic INR 250 SOP default
print("=" * 60)
...
# Test 2: Access control check - LumenWorks customer should NOT be able
# to see Northstar's order (ORD-1001 belongs to ACCT-001)
print("\n" + "=" * 60)
...
# Test 3: Internal mode - proactive issue detection
